...
QString App::TargetAppPath = "/home/bx/projects/vehicleAnalysisOsdk/build";
QString App::TargetAppName = "vehicleAnalysis";
...
void App::readConfig()
{
    ...
    App::TargetAppPath = set.value("TargetAppPath", App::TargetAppPath).toString();
...
void App::writeConfig()
{
    QSettings set(App::ConfigFile, QSettings::IniFormat);
    set.beginGroup("BaseConfig");
    set.setValue("TargetAppPath", App::TargetAppPath);
